<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table ref="multipleTable" :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="数据加载中..." border fit
      ...
      <el-table-column align="center" sortable label="创建时间" prop="create_time">
        <template slot-scope="scope">
          <span>
      ...
      <el-table-column align="center" label="单据类型">
        <template >干线任务</template>
      </el-table-column>
      <el-table-column align="center" label="路线名称">
        <template slot-scope="scope">{{ scope.row.start_short }}--{{ scope.row.end_short }}</template>
      </el-table-column>
      ...
      <el-table-column align="center" class-name="status-col" sortable prop="amount" label="应付金额">
        <template slot-scope="scope">
