<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table ref="multipleTable" :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="数据加载中..." border fit
      ...
      <el-table-column align="center" sortable label="运单时间" prop="create_time">
        <template slot-scope="scope">
          <span>
      ...
      <el-table-column align="center" label="流水单号">
        <template slot-scope="scope"> <span v-for="value in scope.row.upper_to_task"> {{ value }}&nbsp </span> </template>
      </el-table-column>
...
<script>
import { fetchTaskItemList } from '@/api/user'
