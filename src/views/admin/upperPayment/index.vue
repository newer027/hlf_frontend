<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table ref="multipleTable" :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="数据加载中..." border fit
      ...
      <el-table-column align="center" label="运单数量">
...
<script>
import { updateUser, fetchUpperPaymentList } from '@/api/user'
...
export default {
  ...
  methods: {
    getUserList() {
      ...
      fetchUpperPaymentList(this.searchForm).then(res => {
    ...
    reset() {
      ...
      this.searchForm.goods_owner = this.searchForm.serial_id = this.searchForm.invoice_org = this.searchForm.min_create = this.searchForm.max_create = ''
      this.getUserList()
    },
    goWaybillDetail(id) {
      this.$router.push({ path: `upperpayment/${id}` })
    },
    handleSearch() { // 搜索
